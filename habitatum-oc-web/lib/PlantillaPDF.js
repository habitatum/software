...
// EJEMPLO — AJUSTAR cuando se confirmen los colores de marca reales de HABITATUM.
const COLOR_FONDO = '#1f2937';
const COLOR_DORADO = '#b8964f';

const estilos = StyleSheet.create({
  pagina: { padding: 30, fontSize: 10, fontFamily: 'Helvetica' },
  encabezado: { backgroundColor: COLOR_FONDO, color: 'white', padding: 16, marginBottom: 16 },
  ...
  tituloSeccion: { fontSize: 11, fontWeight: 'bold', marginBottom: 4, borderBottom: 1, paddingBottom: 2 },
  tablaEncabezado: { flexDirection: 'row', backgroundColor: '#f0f0f0', padding: 4, fontWeight: 'bold' },
  tablaFila: { flexDirection: 'row', padding: 4, borderBottom: 0.5, borderColor: '#ddd' },
  colDesc: { flex: 4 }, colCant: { flex: 1, textAlign: 'right' }, colVal: { flex: 2, textAlign: 'right' },
  totalDestacado: { fontSize: 13, fontWeight: 'bold', marginTop: 8 },
});
